    ...
    dependencies = {
      {
        ...
        build = (build_cmd ~= "cmake") and "make" or "cmake -S. -Bbuild -DCMAKE_BUILD_TYPE=Release && cmake --build build --config Release && cmake --install build --prefix build",
...
-- NOTE: old telescope config. don't delete this.
-- return {
-- {
--   "nvim-telescope/telescope.nvim",
--   event = "VeryLazy",
...
--     -- { "<leader>xT", false },
--     -- change a keymap
--     -- add a keymap to browse plugin files. -- has been added in other plugin
--     -- {
--     --   "<leader>fP",
--     --   function()
