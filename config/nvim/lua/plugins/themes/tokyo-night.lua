    ...
    config = function()
      require("tokyonight").setup({
        ...
        on_highlights = function(hl, c)
          ...
          hl["CursorLine"] = { bg = "#131319" }

          -- - @markup.raw.block.markdown links to String   priority: 90   language: markdown -- FIX: . check and test this. remove comments later:
          -- - @label.markdown links to @label   priority: 100   language: markdown
        end,
      })
