function load_os_cmds --description "Load OS-specific commands"
    ...
    switch $os
        ...
        case Linux
            ...
            abbr tree2 'tree -a | wl-copy && tree -a'
            ...
            # remove stale or exited sessions
            abbr ar "atch -r"
            ...
            ## nix commands
            abbr -a nr --set-cursor 'nix run nixpkgs#%'
            abbr -a hms 'sudo nixos-rebuild switch --flake ~/dotfiles#jho'
            abbr -a hmsa 'home-manager switch --flake ~/dotfiles#jho --extra-experimental-features "nix-command flakes" -b backup'
